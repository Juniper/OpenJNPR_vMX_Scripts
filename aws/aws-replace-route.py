...
def main():
  ...
  """
    ...
    r = call_aws_ec2(request, region, access_key,
    ...
    if rv.text == 'false':
        ...
        jcs.syslog("external.notice", "set aws ec2 route " +
                   ipv4_prefix + " via " + interface_id + " (" + interface + ") in " + route_table_id + " successful")
#        logging.info("set aws ec2 route " + ipv4_prefix + " via " + interface + " successful")
